...
class TestShop(unittest.TestCase):
    ...
    def test_can_serve__customer_old_enough__returns_true(self):
        self.shop.add_drink(self.drink_2)
        self.assertEqual(True, self.shop.can_serve(self.customer_1, self.drink_2) )


    def test_can_serve__customer_not_old_enough__returns_false(self):
        self.shop.add_drink(self.drink_2)
        self.assertEqual(False, self.shop.can_serve(self.customer_2, self.drink_2) )


    def test_can_serve__customer_not_too_energetic__returns_true(self):
        self.shop.add_drink(self.drink_2)
